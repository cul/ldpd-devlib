var idx = lunr(function () {
  ...
  this.field('tags')
    ...
    this.add({
      ...
      "body": "My relationship with this technology is complicated. Sometimes we feel  so close, and other times so far away. Right now it feels a little rocky. We get  along so well when we’re together so why do I forget so much about you when we’re  apart?",
      "author": "Anice Mills",
      "categories": ["skill development"],
      "tags": [],
      "id": 3
    ...
    this.add({
      "title": "On the fly",
      "body": "I’m so excited about this project. Librarians are accustomed to learning  technology on the fly.  We’re efficient: copying another page’s source code and  substituting our own content was one way to get things done quickly when there wasn’t  time to build something from the ground up.  It’s wonderful to have the opportunity  to work through a project from start to finish.",
      "author": "Sarah Witte",
      "categories": ["skill development"],
      "tags": [],
      "id": 5
    ...
    this.add({
      ...
      "body": "Our Sidebar subgroup, me, Mary and Nick, have completed our task of designing the blog sidebar. We included a link to the syllabus (under Resources) as Alex requested, and focused on simplicity.",
      "author": "Anice Mills",
      "categories": ["project description"],
      "tags": [],
      "id": 6
    ...
    this.add({
      "title": "Milbank Hall",
      "body": "I am interested in using the archives at Barnard to learn more about the early relationship between Barnard and Columbia, especially as the Morningside Heights neighborhood was changing in the late 19th Century. As an object of study, I have chosen Milbank Hall because it is the oldest building on the Barnard campus. Milbank is three connected buildings, Milbank, Brinckerhoff, and Friske Halls. The structures were designed by Charles Rich and built between 1897 and 1898.Milbank Hall, Barnard College. Image by SlamDunkAlan.",
      "author": "Barbara Rockenbach",
      "categories": ["project description"],
      "tags": [],
      "id": 25
    ...
    this.add({
      ...
      "body": "Today we reviewed our Requirements Gathering session from last fall. It is easy to have scope-creep on a project that spans several years. We were reminded that we agreed to do the following:      Each member of the team will choose a site, organization, or monument in Morningside Heights to help tell the story of how the neighborhood changed between 1850-1950 with the addition of Columbia University;        This resource is not an archive of the history of Morningside Heights. We will draw on archives to tell the story of the neighborhood, but this is by no means a comprehensive archive;        We will use Omeka as the tool to tell this story, including Neatline to help visualize the story in a different way;        Each individual will chose items to contribute to the narrative by adding items to Omeka, creating metadata, and forming exhibits;        While the product is important, the process of learning together is the most important aspect of this project. We will return to these requirements often since our ambitions often exceed what can be done in the allotted amount of time for this project!  ",
      "author": "Barbara Rockenbach",
      "categories": ["four-things"],
      "tags": [],
      "id": 33
    ...
    this.add({
      ...
      "body": "From our meeting with Breck on 9/17/13 I took away these four things:      Source code control is external to our site. We will use Git to allow collaboration on code and to keep track of changes. This also enables versioning and being able to roll back changes. LITO is more comfortable with our group creating code if it’s in a repository with dev, test, and prod aspects.        The dev/test/prod relationship is essential in the process of creating a website. We should all be looking at the test version. We will be using dev/test/prod on a VM, virtual machine.        Our site needs to be monitored. Someone should be responsible for checking that it’s functioning properly and has not been hacked or tampered with.        Service level agreements, SLAs, are important arrangements with technology providers. Some issues to arrange: tech support; maintenance of site; security protocols; data backup; encryption; performance requirements.  ",
      "author": "Anice Mills",
      "categories": ["four-things"],
      "tags": [],
      "id": 41
    ...
    this.add({
      "title": "Git Down!",
      "body": "New things:      I learned about using snake (jj_jjj) and camel font (jjJj) for naming.        The importance of creating a WWW folder for web project content.        Git is useful for tracking changes and creating a history of changes. We will  be working in a virtual space on our local computers - content will get uploaded  (committed) to Git and then to server. It is important for us to create a dev and  staging space on server for our web project development.        Commit often!  ",
      "author": "Nancy Friedland",
      "categories": ["four-things"],
      "tags": [],
      "id": 43
    ...
    this.add({
      "title": "Git lost",
      "body": "Four things learned in today’s session:      There is a difference between the Mac and Windows versions of Git which made our session slightly frustrating.        Right now our git only goes to Alex’s server, not to the cloud. Eventually we’ll have a virtual server on our workstations.        Git will keep track of all the versions- or commits- we make to our project. We should “commit often.”        We all created our first repository on Git and created an index.html file. There were some glitches  when we tried to sync this file to github.  ",
      "author": "Anice Mills",
      "categories": ["four-things"],
      "tags": ["git","github"],
      "id": 44
    ...
    this.add({
      ...
      "body": "Git is not easy! I learned the following four things today:1) the difference between Git and Github2) the file structure for projects in Github and on our local computers3) committing often is important for roll back 4) best practices for Git when collaborating with others, i.e. describing major commits",
      "author": "Barbara Rockenbach",
      "categories": ["four-things"],
      "tags": [],
      "id": 45
    ...
    this.add({
      ...
      "body": "Four things learned today, Oct 1, 2013      When working in Github: “commit often.” Commit every time you’ve made a substantial change. Each time that you commit, you create a version that can be rolled back to in the future.        The description field is Optional when you commit. When you are committing something that might change the character or function of the site however, you should provide a reasonably full description of what you have done and why.        The GUI is user friendly but it can only take you so far. At some point we will need to use command language. We will learn more about this later.        Github allows you to create a virtual machine inside your real computer.  ",
      "author": "John L. Tofanelli",
      "categories": ["four-things"],
      "tags": [],
      "id": 46
    ...
    this.add({
      ...
      "body": "Today we got our hands on Git. We’d already installed the software on our office desktops, but it wasn’t installed on the 306 workstations, so we needed to download and install it on the DHC computers for our group session. Four things:      snake_case and CamelCase. We used snake_case to name our Git projects.        The default file folder for our new project put it into the Git folder. This is bad practice. It is better to keep your project folders separate from the software folder. We created a www folders on the c drive and put our project folders there.        Some of us had already clicked “create” to save the projects in the git folder, so Alex showed us how to delete a project on the Github site. It really is called the “Danger Zone”. I thought he was joking!        We created a new index.html file in Notepad ++, and added some text.  Those of us who created our new file in regular Notepad created folders called: index.html.txt. This was corrected by deleting the file, recreating, and then moving it into the project folder. We admired our new project folders in Git on our computers, and reviewed our changes, but when it came time to commit my changes to Git hub, synching failed. Question of the day:  Why did my synching fail?  ",
      "author": "Sarah Witte",
      "categories": ["four-things"],
      "tags": [],
      "id": 47
    ...
    this.add({
      "title": "Four Things",
      "body": "1.  We need to have some way of sharing the work we do.2.  Alex suggests GITHUB3.  We do need some practice.4.  It would be nice to have printed step by step instructions.",
      "author": "Mary Cargill",
      "categories": ["four-things"],
      "tags": [],
      "id": 48
    ...
    this.add({
      ...
      "body": "Today I learned to:1. create a GIT repository2. add a file to the repository3. Make a commit &amp; roll back the commit4. Sync with github and publish",
      "author": "Sarah Witte",
      "categories": ["four-things"],
      "tags": [],
      "id": 49
    ...
    this.add({
      "title": "Git again!",
      "body": "Things I learned from today’s session.Alex did a great job defining differences between Git and GitHub.Git is the tool that manages the source code and history of changes.GitHub is the service that hosts repositories – it is the cloud.Notepad++ is a good text editor for Windows and Alex recommends Textwrangler for Macs.Good practice involves naming each commit as it is important to track changes and understand why you made the changes.",
      "author": "Nancy Friedland",
      "categories": ["four-things"],
      "tags": [],
      "id": 50
    ...
    this.add({
      "title": "Git Clarity",
      "body": "Our second Git session clarified many things for me:1) the difference between Git and Github2) how to create a repository3) how to push changes from Git to Github",
      "author": "Barbara Rockenbach",
      "categories": [],
      "tags": [],
      "id": 52
    ...
    this.add({
      ...
      "body": "My 4 things of note from today’s session on Git and GitHub:      Git is the desktop app (local) and GitHub is the web site (service; shared repository)        using the command-line version of Git (in the shell) allows for functionalitywhich is not offered by the GUI app version        “Rollback” does not retain a copyof the changes FROM WHICH you are rolling back - you need to create a copy, if youwant to retain that version        Cloning in Desktop - this allows you to pull downa repository from GitHub. However, you will need to be authorized by the owner,in order to collaborate and make edits. You can “fork” the project, if you wantto take control of a copy of the repository, as your own project (although, you’llno longer be linked to and participating in the original source repository as acollaborator)  ",
      "author": "Nick Patterson",
      "categories": ["four-things"],
      "tags": [],
      "id": 53
    ...
    this.add({
      "title": "Four Things",
      "body": "      One way to solve problems is to copy and paste the error message and search Google for suggestions.         It would still be a good idea to have printed step by step instructions.         We could use some practice in Notepad++         The explanations of why we use certain functions should be more clear.  ",
      "author": "Mary Cargill",
      "categories": ["four-things"],
      "tags": [],
      "id": 55
    ...
    this.add({
      ...
      "body": "Today’s session on Git, though still frustrating due to glitches in the Windows program, helped clarify the application. Here are the four things I learned:      Github is an application - it’s the tool to manage source code for each project. Github.com is the website which is a hosting service for the repositories.        Notepad++ is the text editor used for coding in Windows.        You can rollback to a previous commit in your repository - this is an extreme move and only used rarely.        Why are we here: to troubleshoot; and to learn how to learn.  ",
      "author": "Anice Mills",
      "categories": ["four-things"],
      "tags": [],
      "id": 56
    ...
    this.add({
      "title": "Site design",
      "body": "      Everything you do in design should have a reason.        Basic elements of a web page: header, body, sidebar, footer        Dividing horizontal space in thirds is eye pleasing and harmonious        We will need to design five types of pages: front page, item page, collection page, exhibit page, and neatline exhibit page  ",
      "author": "Sarah Witte",
      "categories": ["four-things"],
      "tags": [],
      "id": 57
    ...
    this.add({
      ...
      "body": "      The three fundamental principles of screen design are layout, typography, and color.        The still-valid wisdom of the ancients makes the rule of three or the ruler of four probably the best foundation for a good design.        The lack of kerning and a limited number of pixels make sans serif fonts usually the best bet for screen reading.        Responsive design enables one to design variant displays for different media – desktop, ipad, cell phone – by using cascading sets of rules for different screen widths. 5. Bonus thing: the chromatically challenged can get help from a few websites that indicate what the best complementary shades to one’s selected tone will be.  ",
      "author": "Bob Scott",
      "categories": ["four-things"],
      "tags": [],
      "id": 60
    ...
    this.add({
      "title": "Web design",
      "body": "Four things learned in the session today December 17, 2013:      Responsive design responds to variability in screen size. The designer can encode multiple sets of instructions based on different screen sizes. These instructions determine how the design will configure itself for each screen size.        Overlapping elements are a common feature in graphic and typographical design in a print environment. True overlap is not well suited for Web design because Web design is based on entities with distinct boundaries. Web designs that achieve the appearance of overlap are unstable–that is, the composition will change in unpredictable ways on different browsers or with different screen sizes.        Different Web browsers have different protocols for interpreting page encoding. Thus the same page can look different on different browsers and functionality may vary as well.        Three key elements of design are: layout, typography, and color.  ",
      "author": "John L. Tofanelli",
      "categories": ["four-things"],
      "tags": [],
      "id": 61
    ...
    this.add({
      "title": "Web Design",
      "body": "From our session today, 12/17/13, on web design principles:      The 3 elements of web design are: Layout; Typography; Color.        Non-overlapping vs. overlapping design refers to the imaginary boxes either not touching or bleeding into each other.        Responsive design  - site adjusts to screen size.        CSS rules give instructions on print view, screen size.  ",
      "author": "Anice Mills",
      "categories": ["four-things"],
      "tags": ["web design"],
      "id": 62
    ...
    this.add({
      "title": "Resources",
      "body": "Things that inspire and guide our work: Bamboo  DiRT",
      "author": "Barbara Rockenbach",
      "categories": [],
      "tags": [],
      "id": 63
    ...
    this.add({
      "title": "PHP Intro",
      "body": "We had a great PHP intro from Alex.  I really liked the way Alex taught the class. He had about 7 slides and with each slide, he showed us some code and then asked us what we thought it would do.  Then we pasted the code in a scripting site to see if we were right.  He went through the 4 options in the ‘universal machine’ slide (input/output, assignments, conditionals, loops) and showed us how to do each one in PHP.   He also encouraged us to use the Lynda.com and codecademy.com PHP tutorials.  LAMP stack is Linux, Apache, MySQL, PHP.  There are also MAMP (Mac) and WAMP (Windows).  Basic components of Turing’s universal machine (he cautions  that this is grossly simplified):          input/output mechanism (x goes in, y comes out)      capacity to do assignments (x=y)      ability to do simple logic/conditionals (if x then y)      loops/ability to repeat things over and  over again (do x, y times)        Basic PHP Syntax          A PHP script can be placed anywhere in the document      It usually starts with a &lt;php and ends with ?&gt;         php //PHP code goes here ?&gt;                    The default file extension for PHP files is “.php”.      A PHP file normally HTML tags, and some PHP scripting code.      ",
      "author": "Sarah Witte",
      "categories": ["four-things"],
      "tags": [],
      "id": 65
    ...
    this.add({
      ...
      "body": "Four things from today’s session on PHP:  PHP runs on the server to generate webpages; Javascript runs on the browser to animate your webpage.  Functions are the most common way to organize code; can be built-in or user-defined.  Functions can be named and then executed when called.  Syntax: echo means print; strings are text and are indicated by quotation marks; semi-colons separate statements.",
      "author": "Anice Mills",
      "categories": ["four-things"],
      "tags": [],
      "id": 68
    ...
    this.add({
      ...
      "body": "Four things learned:  In the phrase ‘object-oriented programming,’ the word ‘object’ should be construed to mean the data plus the methods information that tell you how the data would like to be used. PHP is an example of object-oriented programming.  We can teach ourselves more about using PHP on Lynda.com.  It is always crucial to include both the beginning and ending tag in PHP:  &lt;?php  ?&gt;  We are studying PHP, as opposed to another programming languge, because PHP is the language used in Omeka.",
      "author": "John L. Tofanelli",
      "categories": ["four-things"],
      "tags": [],
      "id": 69
    ...
    this.add({
      ...
      "body": "The research and editorial process is ongoing.  We have developed a working bibliography included below.  In addition,   we are available to help members of the team focus on their individual work in the  broader context of the project.For instance, we met with one of our participants to discuss and consult on sources in depth about  Riverside Park.  The issues that we identified were:  the development of city parks in general: who they were for, how they were laid out, how they fit into the city landscape, etc.;  we located sources on the history of Riverside Park, specifically, including histories,  documents related to Park, contemporary discussions of it, pictures of it, etc.;  the focus has been to put the selected items in the context of city planning, public services, and clientele.Mary and Elizabeth&lt;Suggested Sources for Morningside HeightsReference SourcesCivic bibliography for Greater New York, ed. by James Bronson Reynolds for the New York research council. New York, Charities Publication Committee, 1911. Also at the Reference Desk R016.352 N48French, John Homer. Gazetteer of the state of New York: embracing a comprehensive view of the geography, geology, and general history of the state, and a complete history and description of every county, city, town, village and locality : with full tables of statistics. Syracuse, R.P. Smith, 1860. Also in Butler Reference R978 F88 Has a section on New York County (p. 418-448) with a lot of statistics and information about services.Report on the social statistics of cities. New York, N.Y. Norman Ross Pub., Year: 1991, 1886.  Issued as part of the 10th census.  New York is in part 1, p. 531-597. Butler Stacks  HA201 1880 v. 18-19.DirectoriesNew York City, New York Online Historical Directories - Online Historical Directories List of New York city directories by decade.  Lists freely available sources as well as commercial ones (mainly ancestry.com)“Check List of World Relating to the Social History of the City of New York—its clubs, charities, hospitals, etc., etc.,—in the New York Public Library”  Bulletin of the New York Public Library, vol. V, no. 6, June 1901. Reference Desk  R016.978N48 N4 The Bulletin is online in Hathi and Google BooksThe New York charities directory. New York, Charity Organization Society in the City of New York, 1888-1920. Most editions are in the stacks at HV99.N59 N5This was also known for some years as the Directory of social and health agencies of New York City  Community Council of Greater New York. Welfare Council of New York City.  Hathi has both titles, but the years don’t always overlap. Hathi has most volumes from 1890-1921.Richmond, John Francis. New York and its institutions, 1609-1873: the bright side of New York. New York, E.B. Treat, 1872.  From the description: ‘A library of information pertaining to the great metropolis, past and present, with historic sketches of its churches, schools, public buildings, parks and cemeteries, of its police, fire, health and quarantine departments, of its prisons, hospitals, homes, asylums, dispensaries and morgue and all municipal and private charitable institutions.’The charities of New York, Brooklyn, and Staten Island. By Henry J. Cammann and Hugh N. Camp. New York, Hurd and Houghton, 1868.Other Online Sources; I found some material searching under “Morningside Heights” as well as more specific topics.  I didn’t list the standard full text sources like Historical newspapers and APS.&lt;/p&gt; &lt;p style='text-align: left;'&gt;GoogleBooks, limiting the search to specific years.HarpWeek. Harper’s Weekly from 1857-1912.  It has a lot of illustrations.",
    ...
    this.add({
      ...
      "body": "Four things to take away from today’s session, PHP part two:  both built-in and user-defined functions are possible in PHP;  arrays can contain lists of data;  there are built-in functions which can sort and output specified data within an array;  the period is used for concatenation in PHP. Bonus takeaway: apparently programmers love to have long flame wars about what is and isn’t ObjectOriented Programming, and whether it’s good or evil!",
      "author": "Nick Patterson",
      "categories": ["four-things"],
      "tags": [],
      "id": 103
    ...
    this.add({
      ...
      "body": "New AppointmentsJohn and I met with Alex to discuss new appointments for Design Team members as the work of this group is winding down. Anice will move to the Editorial Team. Sarah will fully focus on Development Team. Karen was away – we will consult with her on new post shortly. Due to scheduling conflicts, we discussed a new role for Nick. He will assist with staying on top of discussion regarding Omeka.Presentation of DesignAlex presented the work of the Design Team. The team has been hard at work creating our “front page.” See previous post that outlines the process. Overall, the group was delighted with the map, logo, and title. We did not agree on the color palette. Some felt the colors too strong (mix of red and yellow). There was also concern about changing the color of the map. John noted that we are using a historical map for a history research project and we should stay true to the original color palette. There was group consensus to ask Design Team to come back with a subtler color palette.Development TeamBecause of the inclement weather and the rare closing of the university, Development Team had to postpone the migration to the newer version of Omeka. The migration was completed on February 9. We have received the go ahead to begin working on the site. We are still working out backup procedures so best advice – everyone should keep backups of the text for exhibit pages in Microsoft Word or Google Drive.Schedule for Duration of Phase OneWe will continue to meet every two weeks alternating between presentation/updates and a workshop model to provide time for all members of the group to work on their exhibits. We believe that providing time to workshop together will encourage collaborative learning.",
      "author": "Nancy Friedland",
      "categories": ["meeting overview","project management"],
      "tags": [],
      "id": 105
    ...
    this.add({
      ...
      "body": "1. Development Team UpdateThe Development Team showed our group the new home page for our Morningside Heights Digital History project  site. This new page incorporates an historical map for Morningside Heights with  its original colors restored (and slightly heightened for emphasis and clarity).  The page surrounding the map was also revised to be in a color scheme that complemented  the map. These color scheme revisions originated in decisions made in our Design  Team. The revised color scheme represents a departure from our earlier plan of determining  a desired color scheme for home page and altering the map coloring to fit that scheme.2. Transitioning to CUL Server, Current Status and IssuesThere were four outstanding questions which LDPD had addressed to our group. They needed  to have these questions answered prior to transitioning our Project site onto a  server administered by Columbia Libraries. We reached consensus for most of these  questions. For example, we do want the project site cataloged. After considering  the commitment involved in migrating the site again and again as needed, we agreed  that we would: a.) keep it alive until a migration was needed and b.) make sure  that it gets preserved as a frozen site. The Development Team was charged with discussing  issues for which questions remained.3. Summer ScheduleVarious options for a summer schedule were discussed. It was decided, however, to table  this discussion until we have understood more about what will be involved in Phase  2 of project. Phase 1 of the project, the Morningside History website, is still  slated to be launched in June 2015.4. Phase 2The group considered that substantial time and effort had been required for Phase 1 of The Developing  Librarian–the construction of the Morningside History project site. For phase 2  we agreed that we would retain the emphasis on developing and enhancing digital  skills but abandon the idea of all contributing to a single digital project. Instead,  we will work on individual digital projects of our own choosing. We will still dedicate  group time to labs and meetings and we will educate one another about our projects.Action item: Each member should send a description of his or her individual Phase  2 project to Barbara. The Developing Librarian blog will still be actively maintained  to chart our progress in Phase 2.5. Friday open labsBarbara has sent out invitations to the group for a series of Friday open labs in May and early  June. These are optional lab sessions in which group members can work together in  finishing up work needed to be done prior to project site launch in June.",
      "author": "John L. Tofanelli",
    ...
    this.add({
      ...
      "body": "1. Creative Commons License for our Morningside History project siteNear the start of our process, we discussed Creative Commons license  options and settled on a CC-BY 3.0 US License. This is featured on the front page  of our Developing Librarian process / blog site, which states in the bottom margin  “This work is licensed under a CC-BY 3.0 US License.” In our meeting today we  discussed licensing and terms of use issues for our Morningside Heights Digital  History project site. Unlike our process / blog site, our project site contains  a substantial variety of different types of the_content: for example, original exhibit  text written by team authors, images used with permission of institutions, etc.  Various things emerged clearly in the discussion:  We need two kinds of license, or terms of use statements–one covering our original content and one covering images or documents that we are using with permission or through public domain. We haveauthority to determine reuse conditions under a CC license for our original content.For images or documents we did not create, however, we need an appropriate statementin which responsibility for seeking reuse permissions, where needed, is left withthe user.  The default when no CC license statement is included is that originallyauthored materials are covered under ordinary copyright. We decided, however, thatwe should select and apply a specific CC license to the original content on ourproject site. The CC licenses http://creativecommons.org/licenses/ all share in common attribution, or crediting of author, as a basic element. There were varyingopinions about whether or not we should select a CC license that adds ND (no derivatives)and/or NC (no commercial use) onto the basic CC BY license. In the course of ourdiscussion, we found it very helpful to consider Omeka showcase which provides links to a variety of Omeka sites and their statements of terms ofuse conditions.Action Item: Bob Scott and John Tofanelli will draft and send to  the group for approval a terms of use statement for the project site. Once the group  has approved that statement, Bob and John will submit it to Rina Panatalony, Director  of our Copyright Advisory Office for review.2. Libraries Information Technology Office (LITO) guidelinesOur Morningside History project site will be moving to a Columbia University Libraries (CUL) server before it launches publicly this June. We therefore need to bring it into conformity with standards applicable to  all sites housed on CUL servers. We looked at Columbia Univerity Libraries’ “Visual  Identity &amp; Website Guidelines,” which is the key document. Alex will bring our  site into conformity with these guidelines in terms of incorporating Columbia banner,  etc.",
      "author": "John L. Tofanelli",
    ...
    this.add({
      ...
      "body": "Fall is here and the second phase of the Developing Librarian training  program has begun. We are scheduled to meet every other week (Tuesdays 9:30-11am)  and will focus work and discussion on tools and methods appropriate to the digital  humanities at Columbia.Required Reading | Viewing:Digital Humanities in the Library: Challenges and Opportunities for Subject LibrariansMiriam Posner, How Did They Make ThatThe major theme of the 2015 fall semester will be text.Schedule:September 8Basic hardware in the DHC Computational Center (Bob)September 22Basic software in the DHC Computational Center (Bob)October 6Text Mining Hathitrust I: Creating a sub-corpus (Alex)October 20Text Mining Hathitrust II: Analyzing your sub-corpus (Alex)November 3Introduction to data cycle; Data Retrieval: Outwit (Alex &amp; Bob)November 17Semi-Automatic Data Cleanup: Google Refine (Ben)December 1Manual Data Cleanup: EmEditor/Text Wrangler/Oxygen (Terry &amp; Bob)December 15Intro to text analysis: Voyant Tools (Alex &amp; Bob)N.B. In the spring semester we will wrap up the data cycle and leave the curriculum open for new directions that come out of our encounters in the fall, hopefully exploring other media. We are also open to on-demand workshops on any tool or method of interest.",
      "author": "Nancy Friedland",
      "categories": ["project management"],
      "tags": [],
      "id": 115
    ...
    this.add({
      ...
      this.add({
        "title": "Charter",
        "body": "  Project Name  Developing Librarian Project  Project Objective  A team of scholar librarians will create a digital history of Morningside Heights from 1820-1950. The project is important, but the process of learning emergent technologies and research methods is equally if not more important than the project.OutcomesLibrarians involved in this project will…  Develop their own research interests and ability to do digital scholarship.  Acquire ability to partner effectively with scholars on digital projects.Deliverables  A WordPress blog documenting the intellectual and practical process of the project.  An Omeka site on the history of Morningside Heights, 1820-1950.  Audience  Librarians, scholars, students, the public, and educators.  Team Member Roles and Responsibilities  Project Management  Ensure good communication and adherence to timelines. Keeps track of progress. Removes roadblocks. In charge of outreach.  Scholarly Review Team  Verifies references and scholarship, completes environmental scan of similar projects, and pushes the team towards intellectual coherence.  Development Team  Responsible for functionality of site, administration of code base, troubleshooting, debugging, and identifying new technological directions for project.  Design Team  Make recommendations on and implement how the site is organized, presented and contextualized.  Timing and Constraints  The DHC will provide an institutional home for the project.  The project will be completed by January 2015.  Neither the DHC nor the Library assumes responsibility for the sustainability of the project or the blog documenting the project beyond the two years of this agreement.  The project will be well-documented, including the documentation required for ongoing support, and the documentation preserved by the project manager.  Communication  Project members will make every effort to keep in regular contact by email or other electronic means. The preferred means of communication will be email.  Deadlines  Project members will make every effort to attend meetings as arranged. If unable to attend, they will communicate this to the project managers as soon as possible.  Project members will jointly establish and attempt to meet self-imposed deadlines, in part through providing the project with lists of commitments, so that reminders will be sent out as a matter of routine.  Credit  When referring to individual contributions, a team member can speak of that contribution as his or hers. When referring to the whole project, team members should always credit the team. We encourage everyone to share with the team when they make public mentions of the project.When the project is completed, the team will work together to promote the process and project.  Copyright  See post on Copyright and DH.",
        "id": 118
      })
      ...
      this.add({
        ...
        "body": "\tHumanities &amp; History Team,\t\"The Developing Librarian Project,\"\tdh+lib.\tLast modified July 1, 2013.\t\t\t\t\t\t\t\t\t\thttp://acrl.ala.org/dh/2013/07/01/the-developing-librarian-project/.\t\t\t\t\t\t\tMeredith Levin, Alex Gil, Sarah Witte and Bob Scott,\t\"The Developing Librarian Project @ Columbia University,\"\tPoster session at the Digital Library Federation Forum, Atlanta, GA, October 27-29, 2014.\t\t\t\t\t\t\t\t\t\thttps://developinglibrarian.cul.columbia.edu/DLFposter_2014.pdf.\t\t\t\t\t\t\tMegan Browndorf,\t\"Thoughts from the Forum - October 27th,\"\tDigital Library Federation. \tLast modified October 28, 2014.\t\t\t\t\t\t\t\t\t\thttp://www.diglib.org/archives/7009/.\t\t\t\t\t\t\tNisa Bakkalbasi, Damon Jaggars and Barbara Rockenbach (2015),\t\"Re-skilling for the digital humanities: measuring skills, engagement, and learning.\" \tLibrary Management, 36, no. 3: 208-214, accessed on March 16, 2015,\t\t\t\t\t\t\t\t\t\thttp://www.emeraldinsight.com/doi/abs/10.1108/LM-09-2014-0109.\t\t\t\t\t\t",
        "id": 120
      })
      ...
      this.add({
        "title": "Roadmap",
        "body": "Developing Librarian: The Project SiteInstalling WordPress: Introduction to servers.Basic Design Principles: Using themes and widgets.Advanced WordPress techniques: Plug-ins.&nbsp;A Digital History of Morningside Heights: The Product Site6/4 &#8211; Installing Omeka: Revisiting servers.6/18 &#8211; Items &amp; Collections: Populating the database.7/2 &#8211; Metadata, Dublin Core7/16 &#8211; Copyright Law and Creative Commons Licenses8/6 &#8211; Research Management8/20 &#8211; Four things, blogs. Syllabus. Short sessions.9/17 &#8211; Intro to versioning: GIT (Breck and Thomas) and Rackspace.10/01 &#8211; Git Continued10/15 &#8211; Design Principles: Wireframes (CCNMTL)10/29 &#8211; Design Principles: Color Palettes &amp; Typography (do friday)11/19 &#8211; Design Principles: Advanced HTML &amp; CSS12/3 &#8211; Project Management (Mark Newton)12/17 &#8211; Review&nbsp;201401/07 Tour of municipal research center.01/21 Introduction to programming I: PHP02/04 &#8211; Introduction to programming II: PHP02/18 &#8211; The Data Cycle: Obtaining Data from API’s03/04 &#8211; The Data Cycle: Cleaning up Data03/18 &#8211; The Data Cycle: Preservation04/01 &#8211; Design Principles: UX &amp; Javascript.04/15 &#8211; Introduction to security: Protecting our site.05/06 &#8211; Outreach and Publicity&nbsp;&nbsp;Semi-RelatedAs much as time provides, we will do quick tours of the world of contemporary digital humanities. Topics may include:Natural Language ProcessingExperimental forms of scholarly communicationsGIS for the humanitiesForms of Distant ReadingTextual Encoding Initiative",
        "id": 121
      })
      ...
      this.add({
        "title": "Search",
        "body": "Categories:          project description /           skill development /           evaluating new technologies /           tools /           collaboration /           design and interfaces /           metadata /           methods /           books articles and other literature /           research /           four-things /           copyright /           meeting overview /           tutorials /           project management /           comprehension /           development /           editing /           announcements  Tags:          goals /           future of libraries /           omeka /           bamboo dirt /           crowdsourcing /           flowcharts /           project management /           surveys /           design /           readings /           user experience /           frederick law olmsted /           riverside park /           lion brewery /           research /           library resources /           subway /           geographic information systems /           geospatial information studies /           map warper /           maps /           new york public library /           git /           github /           notepad++ /           pedagogy novices /           training /           web design /           coding /           programming languages /           logos /           process /           timelines /           footers /           headers /           sources /           choices /           colors /           fonts /           expectations /           wireframes /           public domain /           internet /           resources  ",
        "id": 122
      })
...
var store = [
  {
    'type': "Post",
    'title': "Developing Librarian Project - Columbia University Libraries",
    'link': "/ldpd-devlib/the-developing-librarian-project-columbia-university-librarians/",
    'category': "project description / skill development",
    'tags': "",
    'excerpt': "The Developing Librarian Project began in the spring of 2012 with the notion of “re-skilling” or training librarians in the Columbia University Libraries Humanities &amp; History team, most of whom..."
  },{
    'type': "Post",
    'title': "Building skills",
    'link': "/ldpd-devlib/building-skills/",
    'category': "skill development",
    'tags': "goals",
    'excerpt': "My hope for this project is that it will present us a hands-on, practical survey of many of the tools and techniques that might be involved in working on digital..."
  },{
    'type': "Post",
    'title': "Evaluating New Technologies",
    'link': "/ldpd-devlib/evaluating-new-technologies-2/",
    'category': "evaluating new technologies",
    'tags': "",
    'excerpt': "As we move forward with our process in developing new skills, I am thinking about how best to evaluate new technologies. Advice suggests we shouldn’t get overly enamored without first..."
  },{
    'type': "Post",
    'title': "Getting Started",
    'link': "/ldpd-devlib/getting-started/",
    'category': "skill development",
    'tags': "",
    'excerpt': "My relationship with this technology is complicated. Sometimes we feel so close, and other times so far away. Right now it feels a little rocky. We get along so well..."
  },{
    'type': "Post",
    'title': "One vision of the project",
    'link': "/ldpd-devlib/my-vision/",
    'category': "project description",
    'tags': "future of libraries",
    'excerpt': "I envision the goals of our project in the following way:Computers and the internet are rapidly changing the face of scholarship, a process perhaps most dramatically illustrated in the humanities,..."
  },{
    'type': "Post",
    'title': "On the fly",
    'link': "/ldpd-devlib/on-the-fly/",
    'category': "skill development",
    'tags': "",
    'excerpt': "I’m so excited about this project. Librarians are accustomed to learning technology on the fly.  We’re efficient: copying another page’s source code and substituting our own content was one way..."
  },{
    'type': "Post",
    'title': "Sidebar Redesigned",
    'link': "/ldpd-devlib/sidebar-redesigned/",
    'category': "project description",
    'tags': "",
    'excerpt': "Our Sidebar subgroup, me, Mary and Nick, have completed our task of designing the blog sidebar. We included a link to the syllabus (under Resources) as Alex requested, and focused..."
  },{
    'type': "Post",
    'title': "New design",
    'link': "/ldpd-devlib/new-design/",
    'category': "",
    'tags': "",
    'excerpt': "John, Junko, and I have met to work on the theme design. We chose a theme called Weaver II, which has a narrow header image that won’t clog up a..."
  },{
    'type': "Post",
    'title': "Adding an RSS feed from a database",
    'link': "/ldpd-devlib/adding-an-rss-feed-from-a-database/",
    'category': "skill development / tools",
    'tags': "",
    'excerpt': "It's fairly easy to create and add an RSS feed to a WordPress blog.1. Go to Appearance &gt; widgets and drag and position the RSS widget on the sidebar.2. Construct your feed. Nearly..."
  },{
    'type': "Post",
    'title': "New Tool: Piazza",
    'link': "/ldpd-devlib/tool-piazza/",
    'category': "collaboration / evaluating new technologies / tools",
    'tags': "",
    'excerpt': "I found this tool in Bamboo DiRT under the category Communicate with Colleagues. Piazza is an open-source web-based discussion tool that works like a chat room. Here’s the link: https://piazza.com/It’s..."
  },{
    'type': "Post",
    'title': "Ant Conc: a classic but very useful tool available on Bamboo Dirt",
    'link': "/ldpd-devlib/ant-conc-classic-tool-bamboo-dirt/",
    'category': "tools",
    'tags': "",
    'excerpt': "A tool that I did not just discover on Bamboo Dirt but that I find very useful and frequently recommend to our researchers is Ant Conc.  It is a traditional..."
  },{
    'type': "Post",
    'title': "New Tool: Pixlr Editor",
    'link': "/ldpd-devlib/tool-pixlr-editor/",
    'category': "evaluating new technologies / tools",
    'tags': "",
    'excerpt': "I decided to look at free web based image editors and think Pixlr is one of the better ones out there. It is not as robust as Photoshop but provides..."
  },{
    'type': "Post",
    'title': "Omeka inspiration",
    'link': "/ldpd-devlib/omeka-inspiration/",
    'category': "design and interfaces / project description",
    'tags': "omeka",
    'excerpt': "When thinking about our Morningside project, I find this Omeka site from the Champaign-Urbana community inspiring, eBlackCU. The eBlackCU is a collaborative portal on African-American history and culture in Champaign-Urbana, Illinois..."
  },{
    'type': "Post",
    'title': "Audio and music tools on Bamboo Dirt",
    'link': "/ldpd-devlib/audio-music-tools-bamboo-dirt/",
    'category': "evaluating new technologies / skill development / tools",
    'tags': "bamboo dirt",
    'excerpt': "I enjoyed the variety of interesting tools that are gathered on Bamboo Dirt, but as I browsed around I noticed that many of the tools dealt with audio from the..."
  },{
    'type': "Post",
    'title': "This great building",
    'link': "/ldpd-devlib/this-great-building/",
    'category': "metadata",
    'tags': "",
    'excerpt': "It is fascinating to look at the variety of documents connected with the early history of the Cathedral Church of Saint John the Divine. The guidebooks and historical accounts are,..."
  },{
    'type': "Post",
    'title': "Tools to Try",
    'link': "/ldpd-devlib/tools/",
    'category': "evaluating new technologies / tools",
    'tags': "crowdsourcing / flowcharts / project management / surveys",
    'excerpt': "While poking around Project Bamboo, I followed a lot of trails that led me to tools that sounded interesting, but which didn’t seem to have a practical application that I..."
  },{
    'type': "Post",
    'title': "Digital Welcome Mats",
    'link': "/ldpd-devlib/digital-mats/",
    'category': "methods",
    'tags': "",
    'excerpt': "We were talking yesterday about the purpose of our Morningside Heights historical Web site. What is the overarching vision or the story we are trying to tell? How do we..."
  },{
    'type': "Post",
    'title': "Showing Change",
    'link': "/ldpd-devlib/change/",
    'category': "tools",
    'tags': "",
    'excerpt': "I was curious to see how Omeka sites have illustrated population growth and other changes over time.  I was hoping to find something similar to the Pastmapper site about Greenwich..."
  },{
    'type': "Post",
    'title': "The importance of the interface",
    'link': "/ldpd-devlib/importance-interface/",
    'category': "books articles and other literature / design and interfaces / skill development",
    'tags': "design / readings / user experience",
    'excerpt': "A follow-up comment on our group discussion of the interesting article suggested by Bob, by Tanya Clement, ‘Half-Baked: The State of Evaluation in the Digital Humanities’ (American Literary History, Volume..."
  },{
    'type': "Post",
    'title': "A Spiritual Building",
    'link': "/ldpd-devlib/a-spiritual-building/",
    'category': "project description / research",
    'tags': "",
    'excerpt': "In his Introduction to The Cathedral Church of St John the Divine (1916), the Very Rev. William Mercer Grosvenor, then Dean of the Cathedral, wrote:  “It is evident that we..."
  },{
    'type': "Post",
    'title': "Leake and Watts Orphan House",
    'link': "/ldpd-devlib/leake-and-watts-orphan-house/",
    'category': "project description",
    'tags': "",
    'excerpt': "I will be investigating the Leake and Watts Orphan House from 1843-1890, when it was located at 112th St. and Amsterdam, the current location of St. John the Divine.  It..."
  },{
    'type': "Post",
    'title': "Riverside Park",
    'link': "/ldpd-devlib/riverside-park/",
    'category': "project description",
    'tags': "frederick law olmsted / riverside park",
    'excerpt': "I am investigating the development of Riverside Park and its landscape architect, Frederick Law Olmsted. I’ll be looking at Riverside Park in the vicinity of Morningside Heights, so from approximately..."
  },{
    'type': "Post",
    'title': "The Lion Brewery",
    'link': "/ldpd-devlib/the-lion-brewery/",
    'category': "project description",
    'tags': "lion brewery / research",
    'excerpt': "Several years ago, when I was a new librarian, the Humanities and History Division went on a field trip to the 42nd Street branch of the New York Public Library. ..."
  },{
    'type': "Post",
    'title': "Bloomingdale Asylum",
    'link': "/ldpd-devlib/bloomingdale-asylum/",
    'category': "four-things",
    'tags': "",
    'excerpt': "For our history of Morningside Heights, I have chosen to concentrate on the Bloomingdale Asylum, which is interesting for a number of reasons.  From its establishment in the Heights until..."
  },{
    'type': "Post",
    'title': "IRT Subway",
    'link': "/ldpd-devlib/irt-subway/",
    'category': "project description",
    'tags': "library resources / subway",
    'excerpt': "Subway Tile, detail, 116th St. (image: Paul Lowry)My plan is to look at the development of the subway in Morningside Heights. The date ranges for our overall project have shifted..."
  },{
    'type': "Post",
    'title': "Milbank Hall",
    'link': "/ldpd-devlib/milbank-hall/",
    'category': "project description",
    'tags': "",
    'excerpt': "I am interested in using the archives at Barnard to learn more about the early relationship between Barnard and Columbia, especially as the Morningside Heights neighborhood was changing in the..."
  },{
    'type': "Post",
    'title': "Rat Rock: A Look at the Landscape of Morningside Heights",
    'link': "/ldpd-devlib/rat-rock-a-look-at-the-landscape-of-morningside-heights/",
    'category': "project description",
    'tags': "",
    'excerpt': "Rat Rock. June 2013. Image by Jennifer Ferretti.When I first visited Manhattan, I couldn’t help but crane my neck upward in order to get a better view of its soaring..."
  },{
    'type': "Post",
    'title': "Fire and Water",
    'link': "/ldpd-devlib/fire-and-water/",
    'category': "project description",
    'tags': "",
    'excerpt': "On the southwest corner of 113th and Amsterdam stand two of the older buildings in Morningside Heights:  the Croton Aqueduct 113th Street gatehouse (1876)  and the  Engine Company No. 47..."
  },{
    'type': "Post",
    'title': "Assessment - Four things",
    'link': "/ldpd-devlib/assessment-four-things/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Following each of our training sessions we have individually submitted a list of four things we learned during the session. The reason we do this is because each training session..."
  },{
    'type': "Post",
    'title': "Omeka Workflow",
    'link': "/ldpd-devlib/omeka/",
    'category': "collaboration / metadata",
    'tags': "",
    'excerpt': "Robbie Blitz, Digital Projects Librarian and Melanie Wacker, Metadata Coordinator, joined us today to discuss Columbia’s Omeka workflow and metadata procedures. As we move into the nuts and bolts of..."
  },{
    'type': "Post",
    'title': "Copyright and Digital Humanities",
    'link': "/ldpd-devlib/copyright-and-digital-humanities/",
    'category': "copyright",
    'tags': "",
    'excerpt': "At one of our last Morningside training sessions Kenny Crews discussed his recent presentations on copyright and DH. We explained our Developing Librarian Project and together we came up with a series..."
  },{
    'type': "Post",
    'title': "Organizing Research with Google Drive and Evernote",
    'link': "/ldpd-devlib/organizing-research-with-google-drive-and-evernote/",
    'category': "methods / tools",
    'tags': "",
    'excerpt': "For the past few weeks, I’ve been viewing archival materials at Columbia’s Rare Book &amp; Manuscript Library (RBML). Two collections have played a significant role in my research: the Buildings..."
  },{
    'type': "Post",
    'title': "St. Luke's Hospital",
    'link': "/ldpd-devlib/st-lukes-hospital/",
    'category': "project description",
    'tags': "",
    'excerpt': "Known today as St. Luke’s-Roosevelt Hospital Center, the hospital was founded by William Augustus Muhlenberg in 1846 and started admitting patients in 1858. It was located at 5th Avenue and..."
  },{
    'type': "Post",
    'title': "Revisiting Requirements Gathering",
    'link': "/ldpd-devlib/revisiting-requirements-gathering/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Today we reviewed our Requirements Gathering session from last fall. It is easy to have scope-creep on a project that spans several years. We were reminded that we agreed to..."
  },{
    'type': "Post",
    'title': "You Can Go Home Again",
    'link': "/ldpd-devlib/you-can-go-home-again/",
    'category': "four-things",
    'tags': "",
    'excerpt': "I thought I knew the four things I had learned from today’s session. They are listed below. But then, when I read Barbara’s post, ‘Revisiting Requirements Guidelines,’ I realized that..."
  },{
    'type': "Post",
    'title': "Warping Maps, Seeing History",
    'link': "/ldpd-devlib/warping-maps-seeing-history/",
    'category': "tools",
    'tags': "geographic information systems / geospatial information studies / map warper / maps / new york public library",
    'excerpt': "New York Public Library's Map Warper.New York Public Library’s Map Warper tool helps you visualize how the landscape of a particular place has changed over time. I signed up for..."
  },{
    'type': "Post",
    'title': "Learning and Teaching and . . .",
    'link': "/ldpd-devlib/learning-and-teaching-and/",
    'category': "four-things",
    'tags': "",
    'excerpt': "In today’s session I and Bob Scott reported to the group on our experience working with Alex Gil to implement a site enhancement. The site enhancement was the introduction of..."
  },{
    'type': "Post",
    'title': "Improving Our WordPress Blog",
    'link': "/ldpd-devlib/enhancing-our-wordpress-blog/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Tuesday’s session was primarily about how to deal with a specific issue in our developing librarian blog.  We decided that we would like to share our “four things” among ourselves..."
  },{
    'type': "Post",
    'title': "Group Meetings Aug 26 and Sept 9",
    'link': "/ldpd-devlib/group-meetings-aug-26-and-sept-9/",
    'category': "meeting overview / metadata / skill development / tutorials",
    'tags': "",
    'excerpt': "Each of these meetings was a combination of instruction with hands on workshop. For 8/26 meeting Bob Scott instructed the group on some finer points of Zotero and worked with..."
  },{
    'type': "Post",
    'title': "Git, Github, branches, forks, commits, and SLAs",
    'link': "/ldpd-devlib/git-github-branches-forks-commits-and-slas/",
    'category': "four-things",
    'tags': "",
    'excerpt': "This morning we had an introduction to Git and to source and version control. Git is open source software that will allow us to preserve and work on our code..."
  },{
    'type': "Post",
    'title': "Responsible Site Development",
    'link': "/ldpd-devlib/responsible-site-development/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Four things learned today 9-17-13 in conversation with guest speaker Breck Witte, Director of Library Information Technology Office. Columbia Libraries wants to extend developer access to people who are not..."
  },{
    'type': "Post",
    'title': "Source Code Control",
    'link': "/ldpd-devlib/source-code-control/",
    'category': "four-things",
    'tags': "",
    'excerpt': "From our meeting with Breck on 9/17/13 I took away these four things: Source code control is external to our site. We will use Git to allow collaboration on code..."
  },{
    'type': "Post",
    'title': "DH tools meltdown",
    'link': "/ldpd-devlib/dh-tools-meltdown/",
    'category': "four-things",
    'tags': "git / github / notepad++ / pedagogy novices",
    'excerpt': "Today our project was to create a repository in Git, to store on the GitHub. It was a bit of a bumpy ride. What did I learn today? 1. Mac Git..."
  },{
    'type': "Post",
    'title': "Git Down!",
    'link': "/ldpd-devlib/get-git/",
    'category': "four-things",
    'tags': "",
    'excerpt': "New things: I learned about using snake (jj_jjj) and camel font (jjJj) for naming. The importance of creating a WWW folder for web project content. Git is useful for tracking..."
  },{
    'type': "Post",
    'title': "Git lost",
    'link': "/ldpd-devlib/git-lost/",
    'category': "four-things",
    'tags': "git / github",
    'excerpt': "Four things learned in today’s session: There is a difference between the Mac and Windows versions of Git which made our session slightly frustrating. Right now our git only goes..."
  },{
    'type': "Post",
    'title': "Git out of here!",
    'link': "/ldpd-devlib/git-out-of-here/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Git is not easy! I learned the following four things today:1) the difference between Git and Github2) the file structure for projects in Github and on our local computers3) committing..."
  },{
    'type': "Post",
    'title': "Gitting to Know You",
    'link': "/ldpd-devlib/gitting-to-know-you/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Four things learned today, Oct 1, 2013 When working in Github: “commit often.” Commit every time you’ve made a substantial change. Each time that you commit, you create a version..."
  },{
    'type': "Post",
    'title': "Gitting Up to Speed",
    'link': "/ldpd-devlib/gitting-up-to-speed/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Today we got our hands on Git. We’d already installed the software on our office desktops, but it wasn’t installed on the 306 workstations, so we needed to download and..."
  },{
    'type': "Post",
    'title': "Four Things",
    'link': "/ldpd-devlib/834/",
    'category': "four-things",
    'tags': "",
    'excerpt': "1.  We need to have some way of sharing the work we do.2.  Alex suggests GITHUB3.  We do need some practice.4.  It would be nice to have printed step by..."
  },{
    'type': "Post",
    'title': "Commits and Syncs",
    'link': "/ldpd-devlib/commits-and-syncs/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Today I learned to:1. create a GIT repository2. add a file to the repository3. Make a commit &amp; roll back the commit4. Sync with github and publish"
  },{
    'type': "Post",
    'title': "Git again!",
    'link': "/ldpd-devlib/git-again/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Things I learned from today’s session.Alex did a great job defining differences between Git and GitHub.Git is the tool that manages the source code and history of changes.GitHub is the..."
  },{
    'type': "Post",
    'title': "Git and GitHub revisited",
    'link': "/ldpd-devlib/git-and-github-revisited/",
    'category': "four-things",
    'tags': "",
    'excerpt': "1. The difference between Git and GitHub is as follows: Git is a tool to manage your source code history. It lives in your computer. GitHub is a hosting service..."
  },{
    'type': "Post",
    'title': "Git Clarity",
    'link': "/ldpd-devlib/git-clarity/",
    'category': "",
    'tags': "",
    'excerpt': "Our second Git session clarified many things for me:1) the difference between Git and Github2) how to create a repository3) how to push changes from Git to Github"
  },{
    'type': "Post",
    'title': "Git down with Git! or perhaps \"Git Down, Stay Down\"?",
    'link': "/ldpd-devlib/git-down-with-git-or-perhaps-git-down-stay-down/",
    'category': "four-things",
    'tags': "",
    'excerpt': "My 4 things of note from today’s session on Git and GitHub: Git is the desktop app (local) and GitHub is the web site (service; shared repository) using the command-line..."
  },{
    'type': "Post",
    'title': "\"If you've got Git, you must commit\"",
    'link': "/ldpd-devlib/if-youve-got-git-you-must-commit/",
    'category': "four-things",
    'tags': "git / github / training",
    'excerpt': "Today’s session with Git/GitHub once again underscored how capriciously tools can behave on different workstations.  We learned a fair amount, but there were still many frustrations for various members of..."
  },{
    'type': "Post",
    'title': "Four Things",
    'link': "/ldpd-devlib/877/",
    'category': "four-things",
    'tags': "",
    'excerpt': "One way to solve problems is to copy and paste the error message and search Google for suggestions.  It would still be a good idea to have printed step by..."
  },{
    'type': "Post",
    'title': "Wrangling with Git",
    'link': "/ldpd-devlib/wrangling-with-git/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Today’s session on Git, though still frustrating due to glitches in the Windows program, helped clarify the application. Here are the four things I learned: Github is an application -..."
  },{
    'type': "Post",
    'title': "Site design",
    'link': "/ldpd-devlib/site-design/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Everything you do in design should have a reason. Basic elements of a web page: header, body, sidebar, footer Dividing horizontal space in thirds is eye pleasing and harmonious We..."
  },{
    'type': "Post",
    'title': "Stemming and the Library Catalog",
    'link': "/ldpd-devlib/stemming-and-the-library-catalog/",
    'category': "evaluating new technologies",
    'tags': "",
    'excerpt': "When this site went live,  we all agreed that we would post regularly.  A schedule was proposed and circulated, and we all signed up to post once every five weeks. ..."
  },{
    'type': "Post",
    'title': "Design",
    'link': "/ldpd-devlib/design/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Alex reprised the Design session from 10/29 because so many of us were out that day. Today’s four things: the most important design elements for two-dimensional design are: color, typography, layout The..."
  },{
    'type': "Post",
    'title': "Screen Design Basics",
    'link': "/ldpd-devlib/screen-design-basics/",
    'category': "four-things",
    'tags': "",
    'excerpt': "The three fundamental principles of screen design are layout, typography, and color. The still-valid wisdom of the ancients makes the rule of three or the ruler of four probably the..."
  },{
    'type': "Post",
    'title': "Web design",
    'link': "/ldpd-devlib/web-design-2/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Four things learned in the session today December 17, 2013: Responsive design responds to variability in screen size. The designer can encode multiple sets of instructions based on different screen..."
  },{
    'type': "Post",
    'title': "Web Design",
    'link': "/ldpd-devlib/web-design/",
    'category': "four-things",
    'tags': "web design",
    'excerpt': "From our session today, 12/17/13, on web design principles: The 3 elements of web design are: Layout; Typography; Color. Non-overlapping vs. overlapping design refers to the imaginary boxes either not..."
  },{
    'type': "Post",
    'title': "Resources",
    'link': "/ldpd-devlib/resources/",
    'category': "",
    'tags': "",
    'excerpt': "Things that inspire and guide our work: Bamboo  DiRT"
  },{
    'type': "Post",
    'title': "Four Things on PHP",
    'link': "/ldpd-devlib/four-things-on-php/",
    'category': "four-things",
    'tags': "",
    'excerpt': "1. For learning more about PHP, we should codecademy.com or Lynda.com.2. PHP is a widely used open source scripting language.3. PHP commands are typically incorporated into pages that begin and..."
  },{
    'type': "Post",
    'title': "PHP Intro",
    'link': "/ldpd-devlib/php-intro/",
    'category': "four-things",
    'tags': "",
    'excerpt': "We had a great PHP intro from Alex. I really liked the way Alex taught the class. He had about 7 slides and with each slide, he showed us some code..."
  },{
    'type': "Post",
    'title': "Hello World! Getting into coding...",
    'link': "/ldpd-devlib/hello-world-getting-into-coding/",
    'category': "methods / skill development / tutorials",
    'tags': "coding / programming languages",
    'excerpt': "We’ve reached the point in our project where the group is beginning to get into basics of coding.I find this phase of the project very engaging. I think all of..."
  },{
    'type': "Post",
    'title': "PHP intro - four things",
    'link': "/ldpd-devlib/php-intro-four-things/",
    'category': "four-things",
    'tags': "",
    'excerpt': "The PHP intro was great. It’s exciting to begin to dig into the code!Four things I took away from this session: PHP runs on the server, and can generate HTML/CSS/JS..."
  },{
    'type': "Post",
    'title': "PHP Programming, Part  2",
    'link': "/ldpd-devlib/php-programming-part-2/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Four things from today’s session on PHP: PHP runs on the server to generate webpages; Javascript runs on the browser to animate your webpage. Functions are the most common way..."
  },{
    'type': "Post",
    'title': "Programming, week 2",
    'link': "/ldpd-devlib/985/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Four things learned: In the phrase ‘object-oriented programming,’ the word ‘object’ should be construed to mean the data plus the methods information that tell you how the data would like..."
  },{
    'type': "Post",
    'title': "Four Things... \"forming teams\" session",
    'link': "/ldpd-devlib/four-things-forming-teams-session/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Today’s session was a more general session, focused on forming teams to move ahead with the work on the site. Four things that I took away from this session:1. as..."
  },{
    'type': "Post",
    'title': "The next phase: teams!",
    'link': "/ldpd-devlib/the-next-phase-teams/",
    'category': "collaboration / methods / skill development",
    'tags': "",
    'excerpt': "During our Developing Librarian session today we formed teams to move the project forward. We have been preparing for this since the project started. After 18 months of training sessions..."
  },{
    'type': "Post",
    'title': "four things learned: project management",
    'link': "/ldpd-devlib/four-things-learned-project-management/",
    'category': "four-things",
    'tags': "",
    'excerpt': "1. One key question in all projects should be: Why? That is, what is my motivation? Whom am I affecting and how?2. Definition of scope is crucial. Which elements need..."
  },{
    'type': "Post",
    'title': "Planning and Managing our Project",
    'link': "/ldpd-devlib/planning-and-managing-our-project/",
    'category': "collaboration / project management",
    'tags': "",
    'excerpt': "Now that our Developing Librarian group has been formed into teams (see message immediately below), we have turned our attention to the areas of project planning and management.On March 4,..."
  },{
    'type': "Post",
    'title': "Once more into the breach!",
    'link': "/ldpd-devlib/once-more-into-the-breach/",
    'category': "collaboration / design and interfaces",
    'tags': "design / logos / process / timelines",
    'excerpt': "Things have been a little quiet on the Developing Librarian front in the past few weeks, as we plunged into our heavy research skills instruction season.  But activity is beginning..."
  },{
    'type': "Post",
    'title': "Timeless and Time Bound",
    'link': "/ldpd-devlib/timeless-and-time-bound/",
    'category': "comprehension / research",
    'tags': "",
    'excerpt': "I have never felt at home in the Cathedral Church of St. John the Divine. To me it has always seemed needlessly massive, incoherent, uninspired, and, perhaps worst of all,..."
  },{
    'type': "Post",
    'title': "If At First You Don’t Succeed… Development Team Lessons in Failure",
    'link': "/ldpd-devlib/if-at-first-you-dont-succeed-development-team-lessons-in-failure/",
    'category': "collaboration / development / methods / skill development",
    'tags': "",
    'excerpt': "We on the Development Team (Meredith, Sarah, Bob, and Nick) have been learning how to use the command line to connect to GitHub, install Omeka, and become developers-in-training. It has..."
  },{
    'type': "Post",
    'title': "Arriving at Ideas for Exhibit Pages",
    'link': "/ldpd-devlib/arriving-at-ideas-for-exhibit-pages/",
    'category': "methods / research",
    'tags': "",
    'excerpt': "For the initial launch date of our Morningside project site, December 2014, we are all expected to have completed three exhibits, and to have provided access to at least twenty..."
  },{
    'type': "Post",
    'title': "Gathering Momentum",
    'link': "/ldpd-devlib/gathering-momentum/",
    'category': "collaboration / design and interfaces / development / methods / project management / skill development / tools",
    'tags': "",
    'excerpt': "In our Developing Librarian Meeting today we moved forward in various ways. The Project Management team (Nancy and John) presented to the group a new central Google-shared space containing a..."
  },{
    'type': "Post",
    'title': "git reset --hard origin",
    'link': "/ldpd-devlib/git-reset-hard-origin/",
    'category': "four-things",
    'tags': "git",
    'excerpt': "Meredith, Bob, and I met this afternoon.  Our assignment from Alex: Put an issue on github create an item in our individual omeka installations. Then back up the database. create..."
  },{
    'type': "Post",
    'title': "Our meeting May 20, 2014",
    'link': "/ldpd-devlib/our-meeting-may-20-2014/",
    'category': "collaboration / meeting overview / metadata / project management",
    'tags': "",
    'excerpt': "In our meeting today we basically focused on two things: the work of our Research and Editorial Team and how to keep this Developing Librarian blog vital and varied–reflective of..."
  },{
    'type': "Post",
    'title': "Design is hard",
    'link': "/ldpd-devlib/design-is-hard/",
    'category': "design and interfaces",
    'tags': "",
    'excerpt': "As part of the Design team, I am struggling with learning Illustrator. We have been charged with creating a logo for the Developing Librarian Project and the paper and pencil..."
  },{
    'type': "Post",
    'title': "Group Meeting June 3, 2014",
    'link': "/ldpd-devlib/group-meeting-june-3-2014/",
    'category': "design and interfaces / meeting overview",
    'tags': "",
    'excerpt': "Our Design Team has been learning Adobe Illustrator and has been working in Illustrator on the creation of two logo options for our Morningside Heights history site. Today both logos..."
  },{
    'type': "Post",
    'title': "Touring Riverside Church",
    'link': "/ldpd-devlib/touring-riverside-church/",
    'category': "research",
    'tags': "",
    'excerpt': "This Sunday, I took the first of what will probably be many tours of the Riverside Church. I’ve been trying to think about what my three exhibits will be and..."
  },{
    'type': "Post",
    'title': "Merging Paths",
    'link': "/ldpd-devlib/merging-paths/",
    'category': "development / skill development",
    'tags': "git",
    'excerpt': "Meredith Levin, Nick Patterson, Bob Scott and Sarah Witte (photographer) in the Studio@ButlerThe developers had a great meeting this morning.  We went through Alex’s assignments, and are all up to..."
  },{
    'type': "Post",
    'title': "Lessons in Project Management",
    'link': "/ldpd-devlib/lessons-in-project-management/",
    'category': "collaboration / methods / project management",
    'tags': "",
    'excerpt': "For our project we have a small but highly capable project management team–myself and Nancy Friedland. A number of our team’s meetings have also included Alex Gil, our Digital Scholarship..."
  },{
    'type': "Post",
    'title': "Group Meeting July 15",
    'link': "/ldpd-devlib/group-meeting-july-15/",
    'category': "meeting overview / project management",
    'tags': "",
    'excerpt': "We welcomed Micah Vandergrift from Florida State University to our meeting. Micah was in residence at Columbia for the week meeting with colleagues in the Center for Digital Research and..."
  },{
    'type': "Post",
    'title': "Group Meeting June 17, 2014",
    'link': "/ldpd-devlib/group-meeting-june-17-2014/",
    'category': "meeting overview / project management / research",
    'tags': "",
    'excerpt': "The Design Team had done additional work on proposed logo designs for our Morningside History Project site. Two designs were presented to the group for a vote and one was..."
  },{
    'type': "Post",
    'title': "Research and editorial team",
    'link': "/ldpd-devlib/research-and-editorial-team/",
    'category': "",
    'tags': "",
    'excerpt': "The research and editorial process is ongoing.  We have developed a working bibliography included below.  In addition,  we are available to help members of the team focus on their individual work..."
  },{
    'type': "Post",
    'title': "Group Meeting July 1, 2014",
    'link': "/ldpd-devlib/group-meeting-july-1-2014/",
    'category': "meeting overview / project management / research",
    'tags': "",
    'excerpt': "Our agenda for the July 1 meeting focused on our individual research projects and an update from the research team. Before we began our discussion, we welcomed a visitor –..."
  },{
    'type': "Post",
    'title': "Design Team: The Steep Learning Curve",
    'link': "/ldpd-devlib/design-team-the-steep-learning-curve/",
    'category': "design and interfaces",
    'tags': "",
    'excerpt': "The Design Team has been grappling with both design principles and the complexities of Adobe Illustrator. We presented two options for website logos that we created in Adobe Illustrator to..."
  },{
    'type': "Post",
    'title': "Design Team update: logo, header, footer...process",
    'link': "/ldpd-devlib/design-team-update-logo-header-footer-process/",
    'category': "collaboration / design and interfaces",
    'tags': "design / footers / headers / logos / sources",
    'excerpt': "Though we haven’t surfaced online in a while, the Design Team has been hard at work.  We have been perfecting logos and considering other sites to figure out what we..."
  },{
    'type': "Post",
    'title': "Project Management: Coordinating Progress",
    'link': "/ldpd-devlib/project-management-coordinating-progress/",
    'category': "collaboration / methods / project management",
    'tags': "",
    'excerpt': "Our project is moving forward along two basic tracks. The first is team accomplishments, and progress here depends heavily on synchronization. For example, the Design Team needed to complete its..."
  },{
    'type': "Post",
    'title': "Collaborative Research",
    'link': "/ldpd-devlib/collaborative-research/",
    'category': "collaboration / research",
    'tags': "",
    'excerpt': "This week we’ve scheduled two “Open Labs” in the Studio@Butler, the library’s collaboratory. Because of the modular furniture in the Studio we’re able to work individually or break into smaller..."
  },{
    'type': "Post",
    'title': "Development Team: Making Strides",
    'link': "/ldpd-devlib/development-team-making-strides/",
    'category': "collaboration / development / skill development",
    'tags': "git / training / web design",
    'excerpt': "The Development Team met yesterday to reinforce our understanding of how to use GitHub to share our code and to try implementing some of the recommendations we received from the..."
  },{
    'type': "Post",
    'title': "Group Meeting, August 12",
    'link': "/ldpd-devlib/group-meeting-august-12/",
    'category': "collaboration / design and interfaces / meeting overview / metadata / project management",
    'tags': "",
    'excerpt': "Announcements and updates Bob Scott announced that he, Meredith, Sarah, and Alex have had a proposal approved for the Digital Library Federation Forum in Atlanta this October. They will be..."
  },{
    'type': "Post",
    'title': "Managing Time and Metadata",
    'link': "/ldpd-devlib/managing-time-and-metadata/",
    'category': "collaboration / comprehension / metadata / project management",
    'tags': "",
    'excerpt': "As the faded Hollywood star played by Elizabeth Taylor in There Must be a Pony (1986) wryly quips ‘That’s the problem with life–bad lighting and no music.’ We might add..."
  },{
    'type': "Post",
    'title': "Group Meeting September 23",
    'link': "/ldpd-devlib/group-meeting-september-23/",
    'category': "collaboration / editing / meeting overview / metadata",
    'tags': "",
    'excerpt': "Following up on recent discussions about the use of metadata in our Morningside Heights Digital History project, we focused more today on implementation and on practice-based rules and agreements. Elizabeth..."
  },{
    'type': "Post",
    'title': "Design Team: Nailing the Details",
    'link': "/ldpd-devlib/design-team-nailing-the-details/",
    'category': "design and interfaces / development",
    'tags': "choices / colors / design / fonts",
    'excerpt': "A scant six weeks after presenting our design choices to the Developing Library group, the Design and Development Teams at last sat down together to hammer out the details for..."
  },{
    'type': "Post",
    'title': "Respecting Deadlines and Project Integrity",
    'link': "/ldpd-devlib/respecting-deadlines-and-project-integrity/",
    'category': "announcements / collaboration / project description / project management / skill development",
    'tags': "",
    'excerpt': "The Project management Team (Nancy Friedland and John Tofanelli) met on Monday to discuss how the Humanities and History team should best move forwards on our Morningside Heights Digital History..."
  },{
    'type': "Post",
    'title': "Group Meeting November 18, 2014",
    'link': "/ldpd-devlib/group-meeting-november-18-2014/",
    'category': "design and interfaces / meeting overview / methods / project description / project management",
    'tags': "",
    'excerpt': "The main focus of today’s meeting was on exhibits.1. What is an exhibit?And what do I need to do to create one? An exhibit is an essay or narrative illustrated..."
  },{
    'type': "Post",
    'title': "Group Meeting December 16, 2014",
    'link': "/ldpd-devlib/group-meeting-december-16-2014/",
    'category': "collaboration / copyright / design and interfaces / meeting overview / methods / project description / project management / skill development",
    'tags': "",
    'excerpt': "1. Team updatesThe Design team has been working on a front page for our public site. It will be handed over to the Development Team for implementation once the design..."
  },{
    'type': "Post",
    'title': "Wireframing",
    'link': "/ldpd-devlib/wireframing/",
    'category': "design and interfaces / development",
    'tags': "expectations / wireframes",
    'excerpt': "The Design Team learned about a new concept this month: wireframes.  These are detailed layouts of what a webpage (home page and interior pages) will look like.  To our dismay,..."
  },{
    'type': "Post",
    'title': "PHP, part two - four things",
    'link': "/ldpd-devlib/php-part-two-four-things/",
    'category': "four-things",
    'tags': "",
    'excerpt': "Four things to take away from today’s session, PHP part two: both built-in and user-defined functions are possible in PHP; arrays can contain lists of data; there are built-in functions..."
  },{
    'type': "Post",
    'title': "Post Holiday, Project Team Meets, and What We Learned About Omeka",
    'link': "/ldpd-devlib/post-holiday-project-team-meets-and-what-we-learned-about-omeka/",
    'category': "project management",
    'tags': "",
    'excerpt': "At our last group meeting on December 16, 2014, we agreed to a February 2, 2015 launch for the project. This provided what we thought would be adequate time to..."
  },{
    'type': "Post",
    'title': "Group Meeting -- January 29",
    'link': "/ldpd-devlib/group-meeting-january-29/",
    'category': "meeting overview / project management",
    'tags': "",
    'excerpt': "New AppointmentsJohn and I met with Alex to discuss new appointments for Design Team members as the work of this group is winding down. Anice will move to the Editorial..."
  },{
    'type': "Post",
    'title': "Public domain resources",
    'link': "/ldpd-devlib/public-domain-resources/",
    'category': "research / tools",
    'tags': "public domain / internet / resources",
    'excerpt': "Here’s a list of some of the resources we’ve learned about over the past several months.  This list will grow over time, so come back!  Feel free to add additional..."
  },{
    'type': "Post",
    'title': "Group Meeting, February 19, 2015",
    'link': "/ldpd-devlib/group-meeting-february-19-2015/",
    'category': "design and interfaces / development / meeting overview / metadata / project management",
    'tags': "",
    'excerpt': "1. Location for Morningside Workshop meetingsThe group agreed that these will be held in our Digital Humanities Center on scheduled Tuesdays 10-11. The computers there have big screens conducive to..."
  },{
    'type': "Post",
    'title': "Fair Use Week",
    'link': "/ldpd-devlib/fair-use-week/",
    'category': "",
    'tags': "",
    'excerpt': "This week marks Fair Use Week in the library world. Fair Use affects all of us as librarians and scholars, but especially in the context of this project, as we..."
  },{
    'type': "Post",
    'title': "Group Meeting, May 5, 2015",
    'link': "/ldpd-devlib/group-meeting-may-5-2015/",
    'category': "development / meeting overview / project management",
    'tags': "",
    'excerpt': "1. Development Team UpdateThe Development Team showed our group the new home page for our Morningside Heights Digital History project site. This new page incorporates an historical map for Morningside..."
  },{
    'type': "Post",
    'title': "Editorial Team Update, May 12, 2015",
    'link': "/ldpd-devlib/editorial-team-update-may-12-2015/",
    'category': "editing / metadata",
    'tags': "",
    'excerpt': "The Editorial Team (Nick Patterson and Anice Mills) led a discussion of Dublin Core requirements for the Morningside Heights Digital History project. We reviewed the metadata fields as defined by..."
  },{
    'type': "Post",
    'title': "Group Meeting May 19, 2015",
    'link': "/ldpd-devlib/group-meeting-may-19-2015/",
    'category': "copyright / meeting overview",
    'tags': "",
    'excerpt': "1. Creative Commons License for our Morningside History project siteNear the start of our process, we discussed Creative Commons license options and settled on a CC-BY 3.0 US License. This..."
  },{
    'type': "Post",
    'title': "Group Meeting June 2, 2015",
    'link': "/ldpd-devlib/group-meeting-june-2-2015/",
    'category': "copyright / meeting overview / metadata / project management",
    'tags': "",
    'excerpt': "1. Terms of use statementThe group discussed and reviewed a terms of use statement that been drafted by Bob and John for the Morningside Heights Digital History (MHDH) project site...."
  },{
    'type': "Post",
    'title': "Dr Strangedevelop, or how I learned to love the team",
    'link': "/ldpd-devlib/dr-strangedevelop-or-how-i-learned-to-love-the-team/",
    'category': "collaboration / development / methods / skill development",
    'tags': "",
    'excerpt': "French librarian graduating from Enssib (the French National Library School), training and interning at Columbia University Libraries for three months, from February to the beginning of May 2015, I was..."
  },{
    'type': "Post",
    'title': "Group Meeting, June 30, 2015",
    'link': "/ldpd-devlib/group-meeting-june-30-2015/",
    'category': "design and interfaces / meeting overview / project management",
    'tags': "",
    'excerpt': "1. Review of MapProject about development of Morningside Heights - historic map is more powerful because of historical context. Not all locations are on current map. Cognitive noise on historic..."
  },{
    'type': "Post",
    'title': "Developing Librarian 2.0",
    'link': "/ldpd-devlib/developing-librarian-2-0/",
    'category': "project management",
    'tags': "",
    'excerpt': "Fall is here and the second phase of the Developing Librarian training program has begun. We are scheduled to meet every other week (Tuesdays 9:30-11am) and will focus work and..."
  },{
    'type': "Post",
    'title': "The Developing Librarian Team Launches Morningside Heights Digital History (MHDH)",
    'link': "/ldpd-devlib/the-developing-librarian-team-launches-morningside-heights-digital-history-mhdh/",
    'category': "announcements",
    'tags': "",
    'excerpt': "Two years ago we announced a professional development program in the Columbia University Libraries for the Humanities &amp; History Division. In our first iteration of the Developing Librarian project or,..."
  },
  {
    'type': "Page",
    'title': "About",
    'link': "/ldpd-devlib/about/",
    'category': "",
    'tags': "",
    'excerpt': "Whether or not the humanities are in the midst of a crisis, much is changing in the humanities research landscape. Libraries and librarians have responded in a number of creative..."
  },{
    'type': "Page",
    'title': "Charter",
    'link': "/ldpd-devlib/charter/",
    'category': "",
    'tags': "",
    'excerpt': "Project Name Developing Librarian Project Project Objective A team of scholar librarians will create a digital history of Morningside Heights from 1820-1950. The project is important, but the process of..."
  },{
    'type': "Page",
    'title': "People",
    'link': "/ldpd-devlib/people/",
    'category': "",
    'tags': "",
    'excerpt': "Ian Beilin Ian Beilin is Humanities Research Services Librarian. He received his PhD in modern European history from Columbia University and his MSIS from The University at Albany. He teaches..."
  },{
    'type': "Page",
    'title': "Publications and Presentations",
    'link': "/ldpd-devlib/publications/",
    'category': "",
    'tags': "",
    'excerpt': "Humanities &amp; History Team, \"The Developing Librarian Project,\" dh+lib. Last modified July 1, 2013. http://acrl.ala.org/dh/2013/07/01/the-developing-librarian-project/. Meredith Levin, Alex Gil, Sarah Witte and Bob Scott, \"The Developing Librarian Project @ Columbia..."
  },{
    'type': "Page",
    'title': "Roadmap",
    'link': "/ldpd-devlib/roadmap/",
    'category': "",
    'tags': "",
    'excerpt': "Developing Librarian: The Project SiteInstalling WordPress: Introduction to servers.Basic Design Principles: Using themes and widgets.Advanced WordPress techniques: Plug-ins.&nbsp;A Digital History of Morningside Heights: The Product Site6/4 &#8211; Installing Omeka: Revisiting..."
  },{
    'type': "Page",
    'title': "Search",
    'link': "/ldpd-devlib/search/",
    'category': "",
    'tags': "",
    'excerpt': "Categories: project description / skill development / evaluating new technologies / tools / collaboration / design and interfaces / metadata / methods / books articles and other literature / research..."
  },{
    'type': "Page",
    'title': "The DHC",
    'link': "/ldpd-devlib/the-dhc/",
    'category': "",
    'tags': "",
    'excerpt': "The Digital Humanities Center (DHC) in 305 Butler Library provides extensive services to support researchers in the humanities working with digital texts, still and moving images, and other materials. We..."
  }
]
